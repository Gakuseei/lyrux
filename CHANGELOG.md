...
- Editor-scoped keybinds: Ctrl+S, Ctrl+F, Ctrl+H, Ctrl+G, Ctrl+L, Ctrl+/, Ctrl+D duplicate-line, Ctrl+Shift+K delete-line, Alt+Up/Down move-line, Ctrl+W close-tab.
...
- Multi-cursor: Alt+click only in MVP; Ctrl+D select-next is a follow-up.
